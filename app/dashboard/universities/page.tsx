          ...
          {universities
            ...
            .map((uni, i) => (
              <motion.div
                ...
                className="glass rounded-2xl border border-white/5 overflow-hidden hover:border-primary/50 transition-all group relative hover:shadow-2xl hover:shadow-primary/5 hover:scale-[1.02]"
              >
                {/* Match Score Badge */}
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <motion.button
                      ...
                      className={`flex-1 py-2 rounded-lg font-bold text-sm transition-all flex items-center justify-center gap-1 cursor-pointer ${
