  ...
  return (
    <section id="features" className="py-24 relative bg-navy-900">
      <div className="container mx-auto px-6">
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-4">Our Core AI Features</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="glass p-8 rounded-2xl hover:bg-white/5 transition-colors group cursor-default border border-white/5 hover:border-white/10"
            >
